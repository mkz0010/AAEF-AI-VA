...
This checkpoint decides the next step after v0.6.100 reviewed and closed the internal narrow public-safe AAEF main handback text drafting candidate.

It decides whether AAEF-AI-VA should pause, prepare final public-safe text, prepare submittable text, or plan a specific AAEF main workflow.
...
AAEF-AI-VA should proceed to a separate narrow public-safe AAEF main handback final-text preparation planning checkpoint.
...
This decision keeps the v0.6.100 close-ready internal candidate text as a reviewer aid only. It does not convert the candidate into final text or submittable text.
...
aaef_main_handback_text_submission_or_pause_decision_completed = true
...
| --- | --- | --- |
| Pause now | not selected | The close-ready candidate supports a safe planning step before any final text or submission workflow. |
| Direct AAEF main submission now | not selected | Too early; final and submittable text have not been separately planned or authorized. |
...
| Prepare final public-safe text now | not selected | Final-text preparation needs a separate planning checkpoint. |
| Prepare submittable text now | not selected | Submittable text requires a separate final-text and workflow decision. |
| Plan final public-safe text preparation | selected | This is the narrowest safe forward step after v0.6.100 close-readiness. |
| Create a handback package now | not selected | Packaging requires a later package decision. |
...
The selected next step may plan narrow public-safe final-text preparation.

The next checkpoint may plan final-text preparation controls, whether and how the v0.6.99 candidate wording could be transformed into future final text, non-submission controls, final-text review gates, target AAEF main workflow options, permitted source material, forbidden source material, whether a later final-text candidate may be created, and how to avoid converting internal candidate wording into submittable text too early.

The next checkpoint should not create final text.

The next checkpoint should not create submittable AAEF main text.

The next checkpoint should not open an AAEF main issue or PR.

## Retained candidate text boundary

The v0.6.99 candidate text remains close-ready but internal only.
...
| --- | --- | --- |
| Who or what acted? | retained_for_final_text_planning | Do not name private tools, private runs, customer targets, or implementation internals. |
| On whose behalf? | retained_for_final_text_planning | Do not claim public samples prove real customer delegation. |
| With what authority? | retained_for_final_text_planning | Do not turn AI output or validator output into authority. |
| Was the action allowed at execution? | retained_for_final_text_planning | Do not authorize runtime execution or imply live execution occurred. |
| What evidence proves what happened? | retained_for_final_text_planning | Do not claim audit sufficiency, legal sufficiency, certification, compliance, readiness, or diagnostic completeness. |
...
| Follow-up item | v0.6.101 status |
| --- | --- |
...
That checkpoint should plan how a future final public-safe handback text candidate could be prepared while preserving evidence/interface boundaries and non-submission controls.
