...
DOC = ROOT / "docs/223-v06147-technical-due-diligence-summary-review-and-decision.md"
ADR = ROOT / "planning/decisions/ADR-0217-add-v06147-technical-due-diligence-summary-review-and-decision.md"
ISSUE = ROOT / "planning/issues/0216-add-v06147-technical-due-diligence-summary-review-and-decision.md"
...
REQUIRED_DOC_PHRASES = ['Status: decision', 'This is checkpoint 2 of 2 for a Medium-risk technical reviewer-facing documentation work item.', 'This checkpoint reviews and accepts the Technical Due Diligence Summary candidate from v0.6.146.', 'The Technical Due Diligence Summary work item is closed.', 'Review conclusion', 'Candidate accepted', 'Technical reviewer fit confirmed', 'Control surface confirmed', 'Repository review surface confirmed', 'Evidence paths confirmed', 'Gate-semantics checks confirmed', 'Non-execution boundaries confirmed', 'Runtime boundary confirmed', 'Credential and data boundary confirmed', 'Public/private artifact boundary confirmed', 'Claim boundaries confirmed', 'Non-authorizing boundary confirmed', 'Reviewed summary sections', 'Review checklist', 'Work item closeout', 'What did not happen', 'Next direction', 'v0.6.148 Next Work Selection Using Risk-Tiered Granularity']
...
FORBIDDEN_AFFIRMATIVE_PHRASES = ['is certified as', 'certified framework for', 'legally compliant with', 'legal compliance achieved', 'audit opinion provided', 'audit sufficiency achieved', 'deployment approved', 'is production ready', 'production-ready scanner', 'complete vulnerability scanner', 'complete vulnerability assessment capability is provided', 'authorized to test third-party systems', 'authorized for third-party testing by this summary', 'equivalent to nist', 'equivalent to iso', 'safe to run without gates', 'ai can safely run tools without gates', 'aaef core promotion = true', 'aaef profile promotion = true', 'aaef practical package promotion = true']
FLAGS = ['technical_due_diligence_summary_review_decision_completed = true', 'technical_due_diligence_summary_review_decision_is_medium_risk = true', 'technical_due_diligence_summary_review_decision_checkpoint_2_of_2 = true', 'technical_due_diligence_summary_candidate_reviewed = true', 'technical_due_diligence_summary_candidate_accepted = true', 'technical_due_diligence_summary_work_item_closed = true', 'technical_due_diligence_summary_file_reviewed = true', 'technical_due_diligence_summary_target_reader_confirmed = true', 'technical_due_diligence_summary_technical_positioning_confirmed = true', 'technical_due_diligence_summary_control_surface_confirmed = true', 'technical_due_diligence_summary_repository_review_surface_confirmed = true', 'technical_due_diligence_summary_evidence_paths_confirmed = true', 'technical_due_diligence_summary_gate_semantics_checks_confirmed = true', 'technical_due_diligence_summary_non_execution_boundary_confirmed = true', 'technical_due_diligence_summary_runtime_boundary_confirmed = true', 'technical_due_diligence_summary_credential_data_boundary_confirmed = true', 'technical_due_diligence_summary_public_private_artifact_boundary_confirmed = true', 'technical_due_diligence_summary_due_diligence_questions_confirmed = true', 'technical_due_diligence_summary_review_artifacts_confirmed = true', 'technical_due_diligence_summary_follow_on_poc_boundary_confirmed = true', 'technical_due_diligence_summary_claim_boundaries_confirmed = true', 'technical_due_diligence_summary_non_authorizing_boundary_confirmed = true', 'technical_due_diligence_summary_reviewer_usefulness_confirmed = true', 'technical_due_diligence_summary_created = true', 'technical_due_diligence_summary_review_decision_completed = true', 'review_decision_completed = true', 'validator_behavior_modified = false', 'metadata_level_expected_failure_category_added = false', 'json_schema_added = false', 'public_sample_changed = false', 'runtime_behavior_modified = false', 'runtime_execution_authorized = false', 'scanner_execution_authorized = false', 'docker_execution_authorized = false', 'credential_injection_permitted = false', 'customer_target_authorized = false', 'delivery_authorized = false', 'aaef_main_handback_sequence_remains_paused = true', 'aaef_main_handback_sequence_reopened = false', 'aaef_main_issue_opened = false', 'aaef_main_pull_request_opened = false', 'aaef_main_issue_submission_command_generated = false', 'aaef_main_issue_url_generated = false', 'safe_poc_boundary_template_created = false', 'control_matrix_created = false', 'reviewer_walkthrough_created = false', 'enterprise_review_guide_modified = false', 'mock_completed_status_renamed = false', 'mock_dry_run_status_behavior_modified = false', 'external_discovery_fail_closed_added = false', 'constraint_diff_enforcement_added = false', 'authorization_expiry_now_check_added = false', 'certification_claim_occurs = false', 'legal_compliance_claim_occurs = false', 'audit_opinion_claim_occurs = false', 'production_readiness_claim_occurs = false', 'external_framework_equivalence_claim_occurs = false', 'diagnostic_completeness_claim_occurs = false', 'third_party_testing_authorization_claim_occurs = false', 'aaef_core_promotion = false', 'aaef_profile_promotion = false', 'aaef_practical_package_promotion = false', 'selected_next_direction = next_work_selection_using_risk_tiered_granularity', 'selected_next_checkpoint = v0.6.148 Next Work Selection Using Risk-Tiered Granularity']
...
def main() -> int:
    for path in [SUMMARY, DOC, ADR, ISSUE, V06146_DOC, V06145_DOC, V06144_DOC, V06143_DOC, V06141_DOC, V06138_DOC, V06134_DOC, V06130_DOC, V06119_DOC]:
    ...
    for phrase in REQUIRED_DOC_PHRASES + FLAGS:
        require(phrase in doc_text, f"v0.6.147 document missing required text: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase in summary_text, f"Technical Due Diligence Summary missing reviewed reviewer question/framing: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase in v06146, f"v0.6.146 candidate missing required phrase: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase not in lower_doc, f"v0.6.147 document must not include affirmative forbidden phrase: {phrase}")

    print("v0.6.147 Technical Due Diligence Summary review and decision tests passed.")
    return 0
