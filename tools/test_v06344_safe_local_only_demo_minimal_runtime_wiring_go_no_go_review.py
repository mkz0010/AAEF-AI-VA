...
def test_v06344_primary_files() -> None:
    ...
    assert_tokens(ISSUE, [
        ...
        "Proceed to v0.6.345 Safe Local-Only Demo Minimal Runtime Wiring Change Candidate",
    ])

def test_v06344_index_files() -> None:
...
def test_v06344_registered_in_run_all() -> None:
    assert_tokens(RUN_ALL, ["tools/test_v06344_safe_local_only_demo_minimal_runtime_wiring_go_no_go_review.py"])

def test_v06344_avoids_raw_forbidden_claim_phrases() -> None:
...
def main() -> None:
    test_v06344_primary_files()
    test_v06344_index_files()
    test_v06344_registered_in_run_all()
    test_v06344_avoids_raw_forbidden_claim_phrases()
    print("v0.6.344 safe local-only demo minimal runtime wiring go/no-go review checks passed")
