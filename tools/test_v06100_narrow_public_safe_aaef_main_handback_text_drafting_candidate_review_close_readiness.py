...
DOC = ROOT / "docs/176-v06100-narrow-public-safe-aaef-main-handback-text-drafting-candidate-review-close-readiness.md"
...
REQUIRED_FLAGS = [
    ...
    "close_narrow_public_safe_aaef_main_handback_text_drafting_candidate = true",
    "retain_v0699_narrow_public_safe_aaef_main_handback_text_drafting_candidate = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_retained = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_reviewed = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_scope_preserved = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_revision_required = false",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_replaced = false",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_uses_v0699_candidate = true",
...
def main() -> int:
    for path in [DOC, V0699_DOC, V0698_DOC, V0655_DOC, INDEX, VALIDATOR]:
    ...
    required_phrases = [
        "Status: review",
        "It is a text drafting candidate review and close-readiness checkpoint only.",
        ...
        "The v0.6.99 narrow internal public-safe AAEF main handback text drafting candidate is close-ready.",
        "not final text, not submittable text",
        "Close-readiness checks",
        "Retained candidate text excerpt",
        ...
        "Candidate text is not final",
        "Candidate text is not submittable",
        "Candidate text is not AAEF main issue text",
        "Candidate text is not AAEF main PR text",
    ...
    for phrase in required_phrases + REQUIRED_FLAGS:
        require(phrase in doc_text, f"v0.6.100 document missing required text: {phrase}")

    for category in EXPECTED_CATEGORIES:
        require(category in doc_text, f"v0.6.100 document missing retained category: {category}")
        ...
        require("expected_failure_category" not in metadata, f"v0.6.100 must not add metadata-level failure category: {category}")
    ...
    for phrase in [
        ...
        require(phrase in v0699, f"v0.6.99 baseline missing required phrase: {phrase}")

    v0698 = V0698_DOC.read_text(encoding="utf-8")
    require("narrow_public_safe_aaef_main_handback_text_drafting_planning_completed = true" in v0698, "v0.6.98 text drafting planning must be completed")
    ...
    for phrase in [
        ...
        "this review writes final aaef main handback text",
        ...
        require(phrase not in lower_doc, f"v0.6.100 document must not include affirmative overclaim phrase: {phrase}")

    print("v0.6.100 narrow public-safe AAEF main handback text drafting candidate review and close-readiness tests passed.")
    return 0
