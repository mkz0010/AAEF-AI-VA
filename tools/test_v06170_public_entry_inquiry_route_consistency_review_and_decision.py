...
DOC = ROOT / "docs/246-v06170-public-entry-and-inquiry-route-consistency-review-review-and-decision.md"
ADR = ROOT / "planning/decisions/ADR-0240-add-v06170-public-entry-and-inquiry-route-consistency-review-and-decision.md"
ISSUE = ROOT / "planning/issues/0239-add-v06170-public-entry-and-inquiry-route-consistency-review-and-decision.md"
...
def main() -> int:
    for path in [README, REVIEW, DOC, ADR, ISSUE, COMMERCIAL_BOUNDARY, V06169_DOC, V06168_DOC, V06167_DOC, V06119_DOC]:
    ...
    for phrase in FLAGS:
        require(phrase in doc_text, f"v0.6.170 document missing flag: {phrase}")
    ...
    v06169 = V06169_DOC.read_text(encoding="utf-8")
    for phrase in [
        ...
        require(phrase in v06169, f"v0.6.169 candidate missing required phrase: {phrase}")

    v06168 = V06168_DOC.read_text(encoding="utf-8")
    require("selected_next_work_item = public_entry_and_inquiry_route_consistency_review" in v06168, "v0.6.168 must select the consistency review work item")
    require("selected_next_work_item_checkpoint_count = 2" in v06168, "v0.6.168 must assign two checkpoints")
    ...
    print("v0.6.170 Public Entry and Inquiry Route Consistency Review review and decision tests passed.")
    return 0
