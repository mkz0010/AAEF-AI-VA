...
DOC = ROOT / "docs/226-v06150-safe-poc-boundary-template-review-and-decision.md"
ADR = ROOT / "planning/decisions/ADR-0220-add-v06150-safe-poc-boundary-template-review-and-decision.md"
ISSUE = ROOT / "planning/issues/0219-add-v06150-safe-poc-boundary-template-review-and-decision.md"
...
REQUIRED_DOC_PHRASES = ['Status: decision', 'This is checkpoint 2 of 2 for a Medium-risk PoC-facing documentation work item.', 'This checkpoint reviews and accepts the Safe PoC Boundary Template candidate from v0.6.149.', 'The Safe PoC Boundary Template work item is closed.', 'Review conclusion', 'Candidate accepted', 'Non-authorizing notice confirmed', 'Written authorization fields confirmed', 'Target scope confirmed', 'Excluded systems confirmed', 'PoC time window confirmed', 'Tool and action limits confirmed', 'AI request and gate boundary confirmed', 'Credential and data handling confirmed', 'Evidence retention and deletion confirmed', 'Human review and approval confirmed', 'Stop conditions confirmed', 'Communications and escalation confirmed', 'Deliverables boundary confirmed', 'Commercial and license boundary confirmed', 'Claim boundaries confirmed', 'Non-authorizing boundary confirmed', 'Reviewed template sections', 'Review checklist', 'Work item closeout', 'What did not happen', 'Next direction', 'v0.6.151 Next Work Selection Using Risk-Tiered Granularity']
...
def main() -> int:
    for path in [TEMPLATE, DOC, ADR, ISSUE, V06149_DOC, V06148_DOC, V06147_DOC, V06144_DOC, V06141_DOC, V06138_DOC, V06134_DOC, V06130_DOC, V06119_DOC]:
    ...
    for phrase in REQUIRED_DOC_PHRASES + FLAGS:
        require(phrase in doc_text, f"v0.6.150 document missing required text: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase in template_text, f"Safe PoC Boundary Template missing reviewed boundary safeguard: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase in v06149, f"v0.6.149 candidate missing required phrase: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase not in lower_doc, f"v0.6.150 document must not include affirmative forbidden phrase: {phrase}")

    print("v0.6.150 Safe PoC Boundary Template review and decision tests passed.")
    return 0
