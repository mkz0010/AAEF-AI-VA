...
DOC = ROOT / "docs/275-v06199-public-demo-readiness-review-candidate.md"
ADR = ROOT / "planning/decisions/ADR-0269-add-v06199-public-demo-readiness-review-candidate.md"
ISSUE = ROOT / "planning/issues/0268-add-v06199-public-demo-readiness-review-candidate.md"
...
REQUIRED_READINESS = ['# Public Demo Readiness Review', 'Status: draft_candidate', 'Do not call the current repository state a Public Demo yet.', 'Static Fixture Review Path', 'public_demo_label_ready = false', 'public_demo_label_should_be_avoided_now = true', 'static_fixture_review_path_publicly_explainable = true', 'What is ready now', 'What is not ready now', 'Public wording recommendation', 'Review decision deferred', 'v0.6.200 Public Demo Readiness Review and Decision']
REQUIRED_DOC = ['Status: candidate', 'This checkpoint is checkpoint 1 of 2 for the Medium-risk Public Demo Readiness Review work item.', 'This checkpoint creates the Public Demo Readiness Review candidate.', 'The review and decision are deferred to v0.6.200.', 'Candidate conclusion: do not call the current repository state a Public Demo yet.', 'Recommended public phrase: Static Fixture Review Path.', 'This checkpoint does not create new fixture files.', 'This checkpoint does not create public samples.', 'This checkpoint does not create a safe demo.', 'This checkpoint does not create a public demo.', 'This checkpoint does not create an executable demo.', 'Candidate artifact', 'Candidate evaluation', 'Recommended wording', 'Deferred items', 'Candidate record', 'What did not happen', 'Next checkpoint']
FLAGS = ['public_demo_readiness_review_candidate_completed = true', 'public_demo_readiness_review_candidate_is_medium_risk = true', 'public_demo_readiness_review_candidate_checkpoint_1_of_2 = true', 'public_demo_readiness_review_decision_deferred_to_v06200 = true', 'public_demo_readiness_review_created = true', 'public_demo_readiness_review_status = draft_candidate', 'public_demo_readiness_review_is_documentation_only = true', 'public_demo_label_ready = false', 'public_demo_label_should_be_avoided_now = true', 'recommended_public_phrase = static_fixture_review_path', 'static_fixture_review_path_publicly_explainable = true', 'accepted_fixture_set_is_reviewable = true', 'accepted_fixture_set_is_not_public_demo = true', 'accepted_fixture_set_is_not_executable_demo = true', 'accepted_fixture_set_is_not_scanner_demo = true', 'accepted_fixture_set_is_not_poc_readiness = true', 'accepted_fixture_set_is_not_delivery_authorization = true', 'accepted_fixture_set_is_not_third_party_testing_authorization = true', 'public_demo_creation_deferred = true', 'public_announcement_deferred = true', 'repository_landing_demo_path_clarity_work_item_closed = true', 'repository_landing_demo_path_clarity_status = accepted', 'safe_demo_fixture_review_path_readme_entry_accepted = true', 'safe_demo_fixture_set_creation_work_item_closed = true', 'safe_demo_fixture_set_status = accepted', 'safe_demo_fixture_set_path = docs/examples/safe-demo/blocked-tool-action-request-review', 'safe_demo_fixture_set_is_static = true', 'safe_demo_fixture_set_is_mock = true', 'safe_demo_fixture_set_is_non_execution = true', 'safe_demo_fixture_set_is_reviewer_facing = true', 'commercial_inquiry_response_boundary_deferred = true', 'commercial_inquiry_response_template_deferred = true', 'aaef_ai_va_interim_inquiry_route_continues = true', 'aaef_ai_va_interim_inquiry_route = hexroot0010@gmail.com', 'aaef_main_contact_publication_remains_deferred = true', 'aaef_main_handback_sequence_remains_paused = true', 'aaef_main_handback_sequence_reopened = false', 'additional_fixture_files_created = false', 'public_samples_created = false', 'safe_demo_created = false', 'public_demo_created = false', 'executable_demo_created = false', 'runtime_scanner_readiness_created = false', 'real_scanner_execution_selected = false', 'runtime_execution_selected = false', 'customer_poc_intake_selected = false', 'runtime_behavior_modified = false', 'runtime_execution_authorized = false', 'scanner_execution_authorized = false', 'docker_execution_authorized = false', 'sensitive_value_injection_permitted = false', 'customer_target_authorized = false', 'customer_poc_authorized = false', 'commercial_contract_created = false', 'paid_engagement_approved = false', 'commercial_license_terms_created = false', 'customer_specific_material_created = false', 'delivery_authorized = false', 'validator_behavior_modified = false', 'metadata_level_expected_failure_category_added = false', 'json_schema_added = false', 'public_sample_changed = false', 'certification_claim_occurs = false', 'legal_compliance_claim_occurs = false', 'audit_opinion_claim_occurs = false', 'production_readiness_claim_occurs = false', 'external_framework_equivalence_claim_occurs = false', 'diagnostic_completeness_claim_occurs = false', 'third_party_testing_authorization_claim_occurs = false', 'aaef_core_promotion = false', 'aaef_profile_promotion = false', 'aaef_practical_package_promotion = false', 'selected_next_checkpoint = v0.6.200 Public Demo Readiness Review and Decision']
FORBIDDEN = ['public demo label ready = true', 'public demo label is ready', 'public demo is ready', 'public demo is created in this checkpoint', 'public demo readiness review is accepted in this checkpoint', 'public demo readiness review work item is closed', 'new fixture files are created in this checkpoint', 'public samples are created in this checkpoint', 'safe demo is created in this checkpoint', 'executable demo is created in this checkpoint', 'runtime work is started in this checkpoint', 'scanner work is started in this checkpoint', 'real scanner execution is selected now', 'runtime execution is selected now', 'customer poc intake is selected now', 'customer poc is authorized', 'commercial contract is created', 'commercial license terms are created', 'paid engagement is approved', 'runtime execution is authorized', 'scanner execution is authorized', 'docker execution is authorized', 'credential injection is permitted', 'sensitive value injection is permitted', 'customer target is authorized', 'delivery is authorized', 'authorized to test third-party systems', 'permission to test third-party systems is granted', 'aaef main contact publication completed', 'aaef main repository modified = true', 'aaef main handback sequence reopened = true', 'is certified as', 'certified framework for', 'legally compliant with', 'audit opinion provided', 'is production ready', 'production-ready scanner', 'complete vulnerability scanner', 'equivalent to nist', 'equivalent to iso', 'ai can safely run tools without gates']
...
def main() -> int:
    for path in [READINESS, DOC, ADR, ISSUE, V06198, V06197, V06196, CLARITY, V06194, V06193, FIXTURE_DIR, *FIXTURE_FILES, V06190, V06187, V06184, V06181, V06172, V06120, V06119]:
    ...
    for phrase in REQUIRED_DOC + FLAGS:
        require(phrase in doc_text, f"v0.6.199 document missing required text: {phrase}")
    ...
    print("v0.6.199 Public Demo Readiness Review candidate tests passed.")
    return 0
