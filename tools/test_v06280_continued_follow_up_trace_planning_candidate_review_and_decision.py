...
DOC = ROOT / "docs/355-v06280-continued-follow-up-trace-planning-candidate-review-and-decision.md"
ADR = ROOT / "planning/decisions/ADR-0355-add-v06280-continued-follow-up-trace-planning-candidate-review-and-decision.md"
ISSUE = ROOT / "planning/issues/0355-add-v06280-continued-follow-up-trace-planning-candidate-review-and-decision.md"
...
def test_v06280_doc_tokens() -> None:
    assert_tokens(DOC, REQUIRED_DOC_TOKENS + REQUIRED_DECISION_TOKENS + REQUIRED_SHARED_TOKENS)


def test_v06280_adr_tokens() -> None:
    assert_tokens(
        ADR,
        [
            "ADR-0355",
            "Status: accepted",
            "Accept the v0.6.279 Continued Follow-Up Trace Planning Candidate",
            "continued_follow_up_trace_planning_candidate_review_completed = true",
            "continued_follow_up_trace_planning_candidate_accepted = true",
            "continued_follow_up_trace_candidate_recommended = true",
            "Continued follow-up trace planning candidate review is not continued trace execution.",
...
def test_v06280_issue_tokens() -> None:
    assert_tokens(
        ISSUE,
        [
            "0355 - Add v0.6.280 Continued Follow-Up Trace Planning Candidate Review and Decision",
            "Status: completed by v0.6.280",
            "continued_follow_up_trace_planning_candidate_review_completed = true",
            "continued_follow_up_trace_planning_candidate_accepted = true",
            "continued_follow_up_trace_planning_candidate_review_result = accepted_for_future_continued_follow_up_trace_planning",
            "future_continued_follow_up_trace_planning_accepted = true",
            ...
            "continued_follow_up_trace_records_created = false",
            "accepted_defect_records_created = false",
            "Proceed to v0.6.281 Next Work Selection Using Risk-Tiered Granularity",
        ],
    )


def test_v06280_index_tokens() -> None:
    assert_tokens(
        README,
        [
            "v0.6.280 Continued Follow-Up Trace Planning Candidate Review and Decision",
    ...
    assert_tokens(
        ...
        [
            "v0.6.280 - Continued Follow-Up Trace Planning Candidate Review and Decision",
            "Accepted the v0.6.279 documentation-only Continued Follow-Up Trace Planning Candidate",
            "continued_follow_up_trace_planning_candidate_review_completed = true",
            "continued_follow_up_trace_planning_candidate_accepted = true",
            "continued_follow_up_trace_planning_candidate_id = continued_follow_up_trace_planning_candidate_v06279",
            "recommended_next_work_item = next_work_selection_using_risk_tiered_granularity",
...
def test_v06280_registered_in_run_all() -> None:
    assert_tokens(RUN_ALL, ["tools/test_v06280_continued_follow_up_trace_planning_candidate_review_and_decision.py"])


def main() -> None:
    test_v06280_doc_tokens()
    test_v06280_adr_tokens()
    test_v06280_issue_tokens()
    test_v06280_index_tokens()
    test_v06280_registered_in_run_all()
    print("v0.6.280 continued follow-up trace planning candidate review and decision checks passed")
