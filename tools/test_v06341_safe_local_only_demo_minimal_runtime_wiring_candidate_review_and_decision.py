...
def test_v06341_primary_files() -> None:
    ...
    assert_tokens(ISSUE, [
        "0416 - Add v0.6.341 Safe Local-Only Demo Minimal Runtime Wiring Candidate Review and Decision",
        "Status: completed by v0.6.341",
        "recommended_next_work_item = safe_local_only_demo_minimal_runtime_wiring_closeout_review",
        "Proceed to v0.6.342 Safe Local-Only Demo Minimal Runtime Wiring Closeout Review",
    ])

def test_v06341_index_files() -> None:
...
def test_v06341_registered_in_run_all() -> None:
    assert_tokens(RUN_ALL, ["tools/test_v06341_safe_local_only_demo_minimal_runtime_wiring_candidate_review_and_decision.py"])

def test_v06341_avoids_raw_forbidden_claim_phrases() -> None:
...
def main() -> None:
    test_v06341_primary_files()
    test_v06341_index_files()
    test_v06341_registered_in_run_all()
    test_v06341_avoids_raw_forbidden_claim_phrases()
    print("v0.6.341 safe local-only demo minimal runtime wiring candidate review and decision checks passed")
