...
DOC = ROOT / "docs/234-v06158-external-review-package-integration-candidate.md"
ADR = ROOT / "planning/decisions/ADR-0228-add-v06158-external-review-package-integration-candidate.md"
ISSUE = ROOT / "planning/issues/0227-add-v06158-external-review-package-integration-candidate.md"
...
REQUIRED_DOC_PHRASES = ['Status: candidate', 'This is checkpoint 1 of 2 for a Medium-risk external-review-facing documentation work item.', 'This checkpoint creates the External Review Package Integration candidate.', 'The review and decision are deferred to v0.6.159.', 'Candidate implementation summary', 'Candidate package artifact', 'Package integration scope', 'Claim boundaries', 'Candidate tests', 'What changed', 'What did not happen', 'Next checkpoint', 'v0.6.159 External Review Package Integration Review and Decision']
...
FLAGS = ['external_review_package_integration_candidate_completed = true', 'external_review_package_integration_candidate_is_medium_risk = true', 'external_review_package_integration_candidate_checkpoint_1_of_2 = true', 'external_review_package_integration_review_decision_deferred_to_v06159 = true', 'external_review_package_created = true', 'external_review_package_candidate_claim_safe = true', 'external_review_package_reader_identified = true', 'external_review_package_purpose_included = true', 'external_review_package_non_authorizing_notice_included = true', 'external_review_package_document_inventory_included = true', 'external_review_package_recommended_entry_points_included = true', 'external_review_package_reviewer_paths_included = true', 'external_review_package_evidence_test_family_index_included = true', 'external_review_package_boundary_non_goal_summary_included = true', 'external_review_package_claim_boundary_summary_included = true', 'external_review_package_questions_can_answer_included = true', 'external_review_package_questions_cannot_answer_included = true', 'external_review_package_safe_poc_template_use_guidance_included = true', 'external_review_package_when_not_to_request_poc_included = true', 'external_review_package_outside_public_package_included = true', 'external_review_package_explicit_non_goals_included = true', 'external_review_package_review_decision_completed = false', 'review_decision_completed = false', 'customer_poc_authorized = false', 'commercial_contract_created = false', 'validator_behavior_modified = false', 'metadata_level_expected_failure_category_added = false', 'json_schema_added = false', 'public_sample_changed = false', 'runtime_behavior_modified = false', 'runtime_execution_authorized = false', 'scanner_execution_authorized = false', 'docker_execution_authorized = false', 'credential_injection_permitted = false', 'customer_target_authorized = false', 'delivery_authorized = false', 'aaef_main_handback_sequence_remains_paused = true', 'aaef_main_handback_sequence_reopened = false', 'aaef_main_issue_opened = false', 'aaef_main_pull_request_opened = false', 'aaef_main_issue_submission_command_generated = false', 'aaef_main_issue_url_generated = false', 'reviewer_walkthrough_modified = false', 'control_matrix_modified = false', 'safe_poc_boundary_template_modified = false', 'technical_due_diligence_summary_modified = false', 'enterprise_review_guide_modified = false', 'mock_completed_status_renamed = false', 'mock_dry_run_status_behavior_modified = false', 'external_discovery_fail_closed_added = false', 'constraint_diff_enforcement_added = false', 'authorization_expiry_now_check_added = false', 'certification_claim_occurs = false', 'legal_compliance_claim_occurs = false', 'audit_opinion_claim_occurs = false', 'production_readiness_claim_occurs = false', 'external_framework_equivalence_claim_occurs = false', 'diagnostic_completeness_claim_occurs = false', 'third_party_testing_authorization_claim_occurs = false', 'aaef_core_promotion = false', 'aaef_profile_promotion = false', 'aaef_practical_package_promotion = false', 'selected_next_checkpoint = v0.6.159 External Review Package Integration Review and Decision']
...
FORBIDDEN_AFFIRMATIVE_PHRASES = [
    ...
    "authorized for third-party testing by this package",
...
def main() -> int:
    for path in [PACKAGE, DOC, ADR, ISSUE, V06157_DOC, V06156_DOC, V06155_DOC, V06153_DOC, V06150_DOC, V06147_DOC, V06144_DOC, V06119_DOC]:
    ...
    for phrase in REQUIRED_DOC_PHRASES + FLAGS:
        require(phrase in doc_text, f"v0.6.158 document missing required text: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase in package_text, f"External Review Package missing safeguard/detail: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase not in lower_doc, f"v0.6.158 document must not include affirmative forbidden phrase: {phrase}")

    print("v0.6.158 External Review Package Integration candidate tests passed.")
    return 0
