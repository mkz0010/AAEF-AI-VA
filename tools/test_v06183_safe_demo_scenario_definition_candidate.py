...
DOC = ROOT / "docs/259-v06183-safe-demo-scenario-definition-candidate.md"
ADR = ROOT / "planning/decisions/ADR-0253-add-v06183-safe-demo-scenario-definition-candidate.md"
ISSUE = ROOT / "planning/issues/0252-add-v06183-safe-demo-scenario-definition-candidate.md"
...
def main() -> int:
    for path in [SCENARIO, DOC, ADR, ISSUE, V06182, V06181, V06179, POSITIONING, SUMMARY, V06173, V06172, V06119]:
    ...
    for phrase in FLAGS:
        require(phrase in doc_text, f"v0.6.183 candidate document missing flag: {phrase}")
    ...
    print("v0.6.183 Safe Demo Scenario Definition candidate tests passed.")
    return 0
