...
DOC = ROOT / "docs/440-v06365-gateway-validation-result-evidence-trace-application-planning-candidate.md"
ADR = ROOT / "planning/decisions/ADR-0440-add-v06365-gateway-validation-result-evidence-trace-application-planning-candidate.md"
ISSUE = ROOT / "planning/issues/0440-add-v06365-gateway-validation-result-evidence-trace-application-planning-candidate.md"
README = ROOT / "README.md"
CHANGELOG = ROOT / "CHANGELOG.md"
ROADMAP = ROOT / "ROADMAP.md"
RUN_ALL = ROOT / "tools/run_all_local_checks.py"

REQUIRED = ['v0.6.365 Gateway Validation Result Evidence Trace Application Planning Candidate', 'gateway_validation_result_evidence_trace_application_planning_candidate_created = true', 'gateway_validation_result_evidence_trace_application_planning_candidate_id = gateway_validation_result_evidence_trace_application_planning_candidate_v06365', 'gateway_validation_result_evidence_trace_application_planning_candidate_status = planning_candidate_pending_review', 'gateway_validation_result_evidence_trace_model_accepted = true', 'gateway_validation_result_evidence_trace_model_decision = accepted_for_reviewer_facing_evidence_trace_direction', 'gateway_validation_result_application_strategy_defined = true', 'gateway_validation_result_application_strategy = staged_private_first_then_schema_or_generated_output_decision', 'gateway_validation_result_application_phase_1_private_reviewer_artifact = recommended', 'gateway_validation_result_application_phase_2_schema_field_decision = deferred', 'gateway_validation_result_application_phase_3_generated_output_application_decision = deferred', 'gateway_validation_result_application_phase_4_runtime_application_decision = deferred', 'gateway_validation_result_application_raw_and_reviewer_status_separation_required = true', 'gateway_validation_result_application_raw_gate_result_preserved = true', 'gateway_validation_result_application_reviewer_status_required = true', 'gateway_validation_result_application_external_process_executed_required = true', 'gateway_validation_result_application_network_activity_performed_required = true', 'gateway_validation_result_application_limitations_required = true', 'gateway_validation_result_application_backward_compatibility_required = true', 'gateway_validation_result_application_schema_change_now = false', 'gateway_validation_result_application_generated_output_change_now = false', 'gateway_validation_result_application_runtime_change_now = false', 'gateway_validation_result_application_public_artifact_change_now = false', 'gateway_validation_result_application_private_artifact_candidate_recommended = true', 'gateway_validation_result_application_public_output_cleanup_dependency = mock_dry_run_status_terminology_public_output_cleanup', 'gateway_validation_result_application_controlled_executor_dependency = controlled_executor_validation_gateway_core_connection', 'gateway_validation_result_application_producer_identity_deferred = true', 'gateway_validation_result_application_hash_or_signature_deferred = true', 'authorization_expiry_current_time_gateway_core_integrated = true', 'authorization_expiry_current_time_gateway_core_candidate_accepted = true', 'request_decision_constraint_diff_gateway_core_integrated = true', 'request_decision_constraint_diff_gateway_core_candidate_accepted = true', 'external_discovery_fail_closed_gateway_core_integrated = true', 'external_discovery_fail_closed_gateway_core_candidate_accepted = true', 'controlled_executor_validation_gateway_core_integrated = false', 'common_target_scope_tool_operation_binding_gateway_core_integrated = false', 'mock_dry_run_status_terminology_public_output_cleanup_required = true', 'implementation_maturity_matrix_available = true', 'readme_front_page_simplification_still_required = true', 'v06365_gateway_core_behavior_changed = false', 'v06365_tool_gateway_behavior_changed = false', 'v06365_runtime_behavior_changed = false', 'v06365_scanner_behavior_changed = false', 'v06365_schema_changed = false', 'v06365_fixtures_created = false', 'v06365_actual_records_created = false', 'v06365_private_generated_outputs_moved_public = false', 'history_rewrite_performed = false', 'repo_recreated = false', 'commercial_offer_approval = false', 'publication_approval = false', 'public_announcement = deferred', 'customer_demo_approval = false', 'safe_local_only_demo_execution_boundary_runtime_applied = false', 'minimal_runtime_wiring_changed = false', 'runtime_enforcement_implemented = false', 'execution_authorized = false', 'real_execution_permitted = false', 'external_target_authorization = false', 'runtime_demo_ready = false', 'scanner_readiness_claim = false', 'production_readiness_claim = false', 'recommended_next_work_item = gateway_validation_result_evidence_trace_application_planning_candidate_review_and_decision', 'gateway_validation_result_evidence_trace_application_planning_candidate_review_and_decision_recommended = true', 'gateway_validation_result_evidence_trace_application_planning_candidate_recommended = false', 'Model output is not authority.', 'AI rationale is not authorization.', 'A gate decision is not AI self-approval.', 'Evidence supports reconstruction; it does not prove legal truth.', 'validator success is structural only', 'publication remains deferred', 'Application planning is not production readiness.', 'Application planning is not scanner readiness.', 'Application planning is not execution authorization.', 'Application planning is not real execution permission.', 'Application planning is not external target authorization.', 'Application planning is not customer demo approval.', 'Application planning is not commercial offer approval.', 'No private generated outputs are moved public in v0.6.365.', 'v0.6.366 Gateway Validation Result Evidence Trace Application Planning Candidate Review and Decision']
...
def test_v06365_primary_files() -> None:
    assert_tokens(DOC, REQUIRED)
    assert_tokens(DOC, [
        "| Phase | Target | Decision in v0.6.365 | Rationale |",
        "| Phase 1 | Private reviewer-facing artifact candidate | recommended |",
...
def test_v06365_index_files() -> None:
...
def test_v06365_registered_in_run_all() -> None:
    assert_tokens(RUN_ALL, ["tools/test_v06365_gateway_validation_result_evidence_trace_application_planning_candidate.py"])

def test_v06365_no_unsupported_claims() -> None:
...
def main() -> None:
    test_v06365_primary_files()
    test_v06365_index_files()
    test_v06365_registered_in_run_all()
    test_v06365_no_unsupported_claims()
    print("v0.6.365 gateway validation result evidence trace application planning candidate checks passed")
