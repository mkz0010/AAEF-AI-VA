...
DOC = ROOT / "docs/264-v06188-next-work-selection-using-risk-tiered-granularity.md"
ADR = ROOT / "planning/decisions/ADR-0258-add-v06188-next-work-selection-using-risk-tiered-granularity.md"
ISSUE = ROOT / "planning/issues/0257-add-v06188-next-work-selection-using-risk-tiered-granularity.md"
...
REQUIRED = ['Status: decision', 'This checkpoint applies the v0.6.120 risk-tiered checkpoint granularity policy.', 'This checkpoint is intentionally completed as one Low-risk checkpoint.', 'The selected next work item is Safe Demo Fixture Set Planning.', 'The selected next work item risk tier is Medium risk.', 'The selected checkpoint count is 2 checkpoints.', 'The next checkpoint is v0.6.189 Safe Demo Fixture Set Planning Candidate.', 'The follow-up checkpoint is v0.6.190 Safe Demo Fixture Set Planning Review and Decision.', 'This checkpoint does not create the Safe Demo Fixture Set Planning artifact.', 'This checkpoint does not create fixture files.', 'This checkpoint does not create public samples.', 'This checkpoint does not create a safe demo.', 'This checkpoint does not create a public demo.', 'This checkpoint does not create an executable demo.', 'This checkpoint does not start runtime or scanner work.', 'This checkpoint does not authorize customer PoC intake.', 'This checkpoint does not modify runtime behavior.', 'This checkpoint does not modify validator behavior.', 'This checkpoint does not add a JSON Schema.', 'No AAEF main issue is opened.', 'No issue creation command is generated.', 'No issue URL is created.', 'Risk-tiered selection record', 'Candidate work items reviewed', 'Selected work item', 'Why this is Medium risk', 'Why not High or Critical risk', 'Why not Low risk', 'Planned checkpoint split', 'Expected Safe Demo Fixture Set Planning scope', 'Claim boundaries for the selected work', 'What did not happen', 'Next direction']
FLAGS = ['next_work_selection_using_risk_tiered_granularity_v06188_completed = true', 'next_work_selection_v06188_is_documentation_only = true', 'next_work_selection_v06188_uses_v06120_granularity_policy = true', 'next_work_selection_v06188_uses_v06187_safe_demo_artifact_planning_closeout = true', 'v06188_completed_as_low_risk_one_checkpoint = true', 'selected_next_work_item = safe_demo_fixture_set_planning', 'selected_next_work_item_risk_tier = medium', 'selected_next_work_item_checkpoint_count = 2', 'selected_next_work_item_first_checkpoint = candidate_implementation', 'selected_next_work_item_second_checkpoint = review_and_decision', 'selected_next_checkpoint = v0.6.189 Safe Demo Fixture Set Planning Candidate', 'selected_followup_checkpoint = v0.6.190 Safe Demo Fixture Set Planning Review and Decision', 'safe_demo_fixture_set_planning_selected = true', 'safe_demo_fixture_set_planning_created = false', 'safe_demo_fixture_set_planning_review_decision_completed = false', 'safe_demo_artifact_planning_work_item_closed = true', 'safe_demo_artifact_planning_status = accepted', 'safe_demo_artifact_planning_supports_accepted_scenario = true', 'safe_demo_scenario_definition_work_item_closed = true', 'safe_demo_scenario_definition_status = accepted', 'safe_demo_scenario_story = blocked_tool_action_request_review', 'safe_demo_scenario_focus = request_gate_evidence_trace', 'safe_demo_scenario_outcome = blocked_or_non_execution_evidence_trace', 'commercial_inquiry_response_boundary_deferred = true', 'commercial_inquiry_response_template_deferred = true', 'public_demo_positioning_work_item_closed = true', 'current_state_executive_summary_work_item_closed = true', 'documentation_and_review_package_layer_status = implemented', 'safe_demo_layer_status = near_term_candidate', 'runtime_scanner_layer_status = deferred_pending_readiness_review', 'customer_poc_layer_status = deferred_pending_commercial_and_scope_boundaries', 'safe_demo_fixture_set_planning_should_follow_accepted_artifact_plan = true', 'safe_demo_fixture_set_planning_should_define_fixture_inventory = true', 'safe_demo_fixture_set_planning_should_define_fixture_file_boundaries = true', 'safe_demo_fixture_set_planning_should_define_request_fixture_boundary = true', 'safe_demo_fixture_set_planning_should_define_gate_decision_fixture_boundary = true', 'safe_demo_fixture_set_planning_should_define_non_execution_result_fixture_boundary = true', 'safe_demo_fixture_set_planning_should_define_evidence_trace_fixture_boundary = true', 'safe_demo_fixture_set_planning_should_define_reviewer_walkthrough_boundary = true', 'safe_demo_fixture_set_planning_should_define_validation_expectations = true', 'safe_demo_fixture_set_planning_should_not_create_fixtures = true', 'safe_demo_fixture_set_planning_should_not_create_public_samples = true', 'safe_demo_fixture_set_planning_should_not_create_executable_demo = true', 'safe_demo_fixture_set_planning_should_not_modify_runtime_behavior = true', 'safe_demo_fixture_set_planning_should_not_modify_validator_behavior = true', 'safe_demo_fixture_set_planning_should_not_add_schema = true', 'aaef_ai_va_interim_inquiry_route_continues = true', 'aaef_ai_va_interim_inquiry_route = hexroot0010@gmail.com', 'aaef_main_contact_publication_remains_deferred = true', 'aaef_main_handback_sequence_remains_paused = true', 'aaef_main_handback_sequence_reopened = false', 'aaef_main_repository_modified = false', 'aaef_main_contact_publication_modified = false', 'aaef_main_issue_opened = false', 'aaef_main_pull_request_opened = false', 'aaef_main_issue_submission_command_generated = false', 'aaef_main_issue_url_generated = false', 'fixture_set_created = false', 'fixture_files_created = false', 'safe_demo_created = false', 'public_demo_created = false', 'executable_demo_created = false', 'runtime_scanner_readiness_created = false', 'real_scanner_execution_selected = false', 'runtime_execution_selected = false', 'customer_poc_intake_selected = false', 'runtime_behavior_modified = false', 'runtime_execution_authorized = false', 'scanner_execution_authorized = false', 'docker_execution_authorized = false', 'credential_injection_permitted = false', 'customer_target_authorized = false', 'customer_poc_authorized = false', 'commercial_contract_created = false', 'paid_engagement_approved = false', 'commercial_license_terms_created = false', 'customer_specific_material_created = false', 'delivery_authorized = false', 'validator_behavior_modified = false', 'metadata_level_expected_failure_category_added = false', 'json_schema_added = false', 'public_sample_changed = false', 'certification_claim_occurs = false', 'legal_compliance_claim_occurs = false', 'audit_opinion_claim_occurs = false', 'production_readiness_claim_occurs = false', 'external_framework_equivalence_claim_occurs = false', 'diagnostic_completeness_claim_occurs = false', 'third_party_testing_authorization_claim_occurs = false', 'aaef_core_promotion = false', 'aaef_profile_promotion = false', 'aaef_practical_package_promotion = false']
FORBIDDEN = ['safe demo fixture set planning is created in this checkpoint', 'fixture files are created in this checkpoint', 'public samples are created in this checkpoint', 'safe demo is created in this checkpoint', 'public demo is created in this checkpoint', 'executable demo is created in this checkpoint', 'runtime work is started in this checkpoint', 'scanner work is started in this checkpoint', 'real scanner execution is selected now', 'runtime execution is selected now', 'customer poc intake is selected now', 'customer poc is authorized', 'commercial contract is created', 'commercial license terms are created', 'paid engagement is approved', 'runtime execution is authorized', 'scanner execution is authorized', 'docker execution is authorized', 'credential injection is permitted', 'customer target is authorized', 'delivery is authorized', 'authorized to test third-party systems', 'permission to test third-party systems is granted', 'aaef main contact publication completed', 'aaef main repository modified = true', 'aaef main handback sequence reopened = true', 'is certified as', 'certified framework for', 'legally compliant with', 'legal compliance achieved', 'audit opinion provided', 'deployment approved', 'is production ready', 'production-ready scanner', 'complete vulnerability scanner', 'equivalent to nist', 'equivalent to iso', 'ai can safely run tools without gates']
...
def main() -> int:
    for path in [DOC, ADR, ISSUE, V06187, PLAN, V06186, V06184, SCENARIO, V06181, V06179, POSITIONING, SUMMARY, V06173, V06172, V06120, V06119]:
        require(path.exists(), f"missing required file: {path.relative_to(ROOT)}")

    doc_text = DOC.read_text(encoding="utf-8")
    for phrase in REQUIRED + FLAGS:
        require(phrase in doc_text, f"v0.6.188 document missing required text: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase in plan, f"safe demo artifact planning missing required phrase: {phrase}")
    ...
    for phrase in FORBIDDEN:
        require(phrase not in lower_doc, f"v0.6.188 document must not include affirmative forbidden phrase: {phrase}")

    print("v0.6.188 next work selection using risk-tiered granularity tests passed.")
    return 0
