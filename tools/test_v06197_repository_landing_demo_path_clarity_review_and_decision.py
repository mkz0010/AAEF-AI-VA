...
DOC = ROOT / "docs/273-v06197-repository-landing-demo-path-clarity-review-and-decision.md"
ADR = ROOT / "planning/decisions/ADR-0267-add-v06197-repository-landing-demo-path-clarity-review-and-decision.md"
ISSUE = ROOT / "planning/issues/0266-add-v06197-repository-landing-demo-path-clarity-review-and-decision.md"
...
def main() -> int:
    for path in [CLARITY, DOC, ADR, ISSUE, README, V06196, V06195, V06194, V06193, FIXTURE_DIR, *FIXTURE_FILES, V06192, V06190, V06181, V06172, V06120, V06119]:
    ...
    for phrase in REQUIRED_DOC + FLAGS:
        require(phrase in doc_text, f"v0.6.197 document missing required text: {phrase}")
    ...
    print("v0.6.197 Repository Landing and Demo Path Clarity review and decision tests passed.")
    return 0
