...
DOC = ROOT / "docs/303-v06227-next-work-selection-using-risk-tiered-granularity.md"
ADR = ROOT / "planning/decisions/ADR-0297-add-v06227-next-work-selection-using-risk-tiered-granularity.md"
ISSUE = ROOT / "planning/issues/0296-add-v06227-next-work-selection-using-risk-tiered-granularity.md"
...
FORBIDDEN_TOKENS = [
    "evidence_linkage_table_created = true",
...
def test_v06227_files_exist_and_record_selection() -> None:
...
def test_v06227_repository_surfaces_selection() -> None:
...
def test_v06227_does_not_apply_linkage_flow_cleanup_gateway_runtime_publication_or_assurance_changes() -> None:
...
def test_v06227_run_all_registers_local_test() -> None:
    run_all = read(RUN_ALL)
    assert "tools/test_v06227_next_work_selection_using_risk_tiered_granularity.py" in run_all


if __name__ == "__main__":
    test_v06227_files_exist_and_record_selection()
    test_v06227_repository_surfaces_selection()
    test_v06227_does_not_apply_linkage_flow_cleanup_gateway_runtime_publication_or_assurance_changes()
    test_v06227_run_all_registers_local_test()
    print("v0.6.227 Next Work Selection Using Risk-Tiered Granularity checks passed")
