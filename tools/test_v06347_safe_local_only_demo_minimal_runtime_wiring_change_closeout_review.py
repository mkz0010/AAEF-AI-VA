...
DOC = ROOT / "docs/422-v06347-safe-local-only-demo-minimal-runtime-wiring-change-closeout-review.md"
ADR = ROOT / "planning/decisions/ADR-0422-add-v06347-safe-local-only-demo-minimal-runtime-wiring-change-closeout-review.md"
ISSUE = ROOT / "planning/issues/0422-add-v06347-safe-local-only-demo-minimal-runtime-wiring-change-closeout-review.md"
README = ROOT / "README.md"
CHANGELOG = ROOT / "CHANGELOG.md"
ROADMAP = ROOT / "ROADMAP.md"
RUN_ALL = ROOT / "tools/run_all_local_checks.py"

REQUIRED = ['v0.6.347 Safe Local-Only Demo Minimal Runtime Wiring Change Closeout Review', 'safe_local_only_demo_minimal_runtime_wiring_change_closeout_review_completed = true', 'safe_local_only_demo_minimal_runtime_wiring_change_closeout_review_id = safe_local_only_demo_minimal_runtime_wiring_change_closeout_review_v06347', 'safe_local_only_demo_minimal_runtime_wiring_change_closeout_review_result = track_closed_runtime_wiring_changed_false', 'safe_local_only_demo_minimal_runtime_wiring_change_track_status = closed', 'safe_local_only_demo_minimal_runtime_wiring_change_track_outcome = bounded_change_candidate_accepted_not_runtime_wiring_changed', 'safe_local_only_demo_minimal_runtime_wiring_change_candidate_review_completed = true', 'safe_local_only_demo_minimal_runtime_wiring_change_candidate_accepted = true', 'safe_local_only_demo_minimal_runtime_wiring_change_candidate_id = safe_local_only_demo_minimal_runtime_wiring_change_candidate_v06345', 'safe_local_only_demo_minimal_runtime_wiring_change_candidate_review_result = accepted_as_bounded_candidate_not_runtime_wiring_changed', 'safe_local_only_demo_minimal_runtime_wiring_change_candidate_status = accepted_not_runtime_wiring_changed', 'safe_local_only_demo_minimal_runtime_wiring_go_no_go_review_completed = true', 'safe_local_only_demo_minimal_runtime_wiring_go_no_go_decision = conditional_go', 'safe_local_only_demo_minimal_runtime_wiring_go_no_go_review_result = conditional_go_for_bounded_runtime_wiring_change_candidate_not_runtime_wiring_changed', 'safe_local_only_demo_minimal_runtime_wiring_closeout_review_completed = true', 'safe_local_only_demo_minimal_runtime_wiring_track_status = closed', 'safe_local_only_demo_minimal_runtime_wiring_track_outcome = bounded_candidate_accepted_not_runtime_wiring_changed', 'safe_local_only_demo_execution_boundary_review_completed = true', 'safe_local_only_demo_execution_boundary_accepted = true', 'safe_local_only_demo_execution_boundary_target_mode = localhost_only', 'safe_local_only_demo_execution_boundary_status = accepted_not_runtime_applied', 'safe_local_only_demo_execution_boundary_runtime_applied = false', 'safe_local_only_demo_execution_boundary_applied = false', 'safe_local_only_runnable_demo_ready = true', 'safe_local_only_runnable_demo_ready_scope = mock_first_localhost_only_reviewer_demo', 'safe_local_only_runnable_demo_public_ready = false', 'publication_approval = false', 'public_announcement = deferred', 'runtime_demo_ready = false', 'scanner_readiness_claim = false', 'production_readiness_claim = false', 'execution_authorized = false', 'real_execution_permitted = false', 'external_target_authorization = false', 'minimal_runtime_wiring_change_closeout_existing_safe_local_runner_outputs_preserved = true', 'minimal_runtime_wiring_change_closeout_allowed_blocked_human_approval_visibility_preserved = true', 'minimal_runtime_wiring_change_closeout_localhost_only_binding_preserved = true', 'minimal_runtime_wiring_change_closeout_loopback_only_target_preserved = true', 'minimal_runtime_wiring_change_closeout_mock_first_default_preserved = true', 'minimal_runtime_wiring_change_closeout_private_artifact_boundary_preserved = true', 'minimal_runtime_wiring_change_closeout_no_external_target_authorization_preserved = true', 'minimal_runtime_wiring_change_closeout_no_real_scanner_execution_preserved = true', 'minimal_runtime_wiring_change_closeout_no_gateway_behavior_change_preserved = true', 'minimal_runtime_wiring_change_closeout_no_runtime_behavior_change_preserved = true', 'minimal_runtime_wiring_change_closeout_no_scanner_behavior_change_preserved = true', 'minimal_runtime_wiring_change_closeout_no_schema_behavior_change_preserved = true', 'minimal_runtime_wiring_change_closeout_reversal_or_rollback_boundary_preserved = true', 'minimal_runtime_wiring_change_closeout_preflight_and_authorization_false_states_preserved = true', 'minimal_runtime_wiring_change_closeout_reviewer_visible_outcomes_preserved = true', 'minimal_runtime_wiring_change_closeout_fail_closed_paths_preserved = true', 'minimal_runtime_wiring_change_closeout_claim_boundary_preservation_confirmed = true', 'tool_gateway_behavior_changed = false', 'adapter_behavior_changed = false', 'schema_changed = false', 'runtime_behavior_changed = false', 'scanner_behavior_changed = false', 'fixtures_created = false', 'record_candidate_artifacts_created = false', 'actual_records_created = false', 'private_generated_outputs_moved_public = false', 'preflight_satisfied = false', 'concrete_checks_implemented = false', 'live_evidence_records_generated = false', 'runtime_enforcement_implemented = false', 'minimal_runtime_wiring_changed = false', 'recommended_next_work_item = next_work_selection_using_risk_tiered_granularity', 'next_work_selection_using_risk_tiered_granularity_recommended = true', 'safe_local_only_demo_minimal_runtime_wiring_change_closeout_review_recommended = false', 'Model output is not authority.', 'AI rationale is not authorization.', 'A gate decision is not AI self-approval.', 'Evidence supports reconstruction; it does not prove legal truth.', 'validator success is structural only', 'publication remains deferred', 'minimal runtime wiring change closeout review is not runtime wiring', 'minimal runtime wiring change closeout review is not runtime application', 'minimal runtime wiring change closeout review is not execution authorization', 'minimal runtime wiring change closeout review is not real execution permission', 'minimal runtime wiring change closeout review is not external target authorization', 'minimal runtime wiring change closeout review is not public demo readiness', 'minimal runtime wiring change closeout review is not scanner readiness', 'minimal runtime wiring change closeout review is not production readiness', 'No private generated outputs are moved public in v0.6.347.', 'v0.6.348 Next Work Selection Using Risk-Tiered Granularity']
...
def test_v06347_primary_files() -> None:
    ...
    assert_tokens(ISSUE, [
        ...
        "Proceed to v0.6.348 Next Work Selection Using Risk-Tiered Granularity",
    ])

def test_v06347_index_files() -> None:
...
def test_v06347_registered_in_run_all() -> None:
    assert_tokens(RUN_ALL, ["tools/test_v06347_safe_local_only_demo_minimal_runtime_wiring_change_closeout_review.py"])

def test_v06347_avoids_raw_forbidden_claim_phrases() -> None:
...
def main() -> None:
    test_v06347_primary_files()
    test_v06347_index_files()
    test_v06347_registered_in_run_all()
    test_v06347_avoids_raw_forbidden_claim_phrases()
    print("v0.6.347 safe local-only demo minimal runtime wiring change closeout review checks passed")
