...
DOC = ROOT / "docs/194-v06118-narrow-public-safe-aaef-main-handback-human-maintainer-final-submission-decision-or-pause.md"
...
def main() -> int:
    for path in [DOC, V06117_DOC, V06116_DOC, V0655_DOC, INDEX, VALIDATOR]:
    ...
    for phrase in REQUIRED_PHRASES + REQUIRED_FLAGS:
        require(phrase in doc_text, f"v0.6.118 document missing required text: {phrase}")

    for category in EXPECTED_CATEGORIES:
        require(category in doc_text, f"v0.6.118 document missing retained category: {category}")
        ...
        require("expected_failure_category" not in metadata, f"v0.6.118 must not add metadata-level failure category: {category}")
    ...
    for phrase in [
        "narrow_public_safe_aaef_main_handback_human_submission_checklist_review_close_readiness_completed = true",
        "human_submission_checklist_review_completed = true",
        "human_submission_checklist_close_ready = true",
        ...
        "selected_next_step_after_human_submission_checklist_close_readiness = narrow_public_safe_aaef_main_handback_human_maintainer_final_submission_decision_or_pause",
        "narrow_public_safe_aaef_main_handback_human_maintainer_final_submission_decision_or_pause_authorized_for_next_checkpoint = true",
        ...
        require(phrase in v06117, f"v0.6.117 baseline missing required phrase: {phrase}")

    v06116 = V06116_DOC.read_text(encoding="utf-8")
    require("human_submission_checklist_prepared = true" in v06116, "v0.6.116 must prepare checklist")
    ...
    for phrase in [
        ...
        require(phrase not in lower_doc, f"v0.6.118 document must not include affirmative overclaim phrase: {phrase}")

    print("v0.6.118 narrow public-safe AAEF main handback human-maintainer final submission decision or pause tests passed.")
    return 0
