...
DOC = ROOT / 'docs/420-v06345-safe-local-only-demo-minimal-runtime-wiring-change-candidate.md'
ADR = ROOT / 'planning/decisions/ADR-0420-add-v06345-safe-local-only-demo-minimal-runtime-wiring-change-candidate.md'
ISSUE = ROOT / 'planning/issues/0420-add-v06345-safe-local-only-demo-minimal-runtime-wiring-change-candidate.md'
README = ROOT / "README.md"
CHANGELOG = ROOT / "CHANGELOG.md"
ROADMAP = ROOT / "ROADMAP.md"
RUN_ALL = ROOT / "tools/run_all_local_checks.py"

REQUIRED = ['v0.6.345 Safe Local-Only Demo Minimal Runtime Wiring Change Candidate',
 'safe_local_only_demo_minimal_runtime_wiring_change_candidate_created = true',
 'safe_local_only_demo_minimal_runtime_wiring_change_candidate_id = '
 'safe_local_only_demo_minimal_runtime_wiring_change_candidate_v06345',
 ...
 'safe_local_only_demo_minimal_runtime_wiring_go_no_go_review_id = '
 'safe_local_only_demo_minimal_runtime_wiring_go_no_go_review_v06344',
 'safe_local_only_demo_minimal_runtime_wiring_go_no_go_review_result = '
 ...
 'safe_local_only_demo_minimal_runtime_wiring_closeout_review_id = '
 'safe_local_only_demo_minimal_runtime_wiring_closeout_review_v06342',
 ...
 'safe_local_only_demo_minimal_runtime_wiring_candidate_id = '
 'safe_local_only_demo_minimal_runtime_wiring_candidate_v06340',
 ...
 'minimal_runtime_wiring_change_candidate_proposed_artifact = '
 'safe_local_only_minimal_runtime_wiring_change_candidate_record',
...
def test_v06345_primary_files() -> None:
    assert_tokens(DOC, REQUIRED)
    assert_tokens(ADR, ["ADR-0420", "Status: proposed candidate", "Create the runtime wiring change candidate as a bounded candidate only."])
    assert_tokens(ISSUE, [
        "0420 - Add v0.6.345 Safe Local-Only Demo Minimal Runtime Wiring Change Candidate",
        "Status: completed by v0.6.345",
        "recommended_next_work_item = safe_local_only_demo_minimal_runtime_wiring_change_candidate_review_and_decision",
        "Proceed to v0.6.346 Safe Local-Only Demo Minimal Runtime Wiring Change Candidate Review and Decision",
    ])

def test_v06345_index_files() -> None:
...
def test_v06345_registered_in_run_all() -> None:
    assert_tokens(RUN_ALL, ['tools/test_v06345_safe_local_only_demo_minimal_runtime_wiring_change_candidate.py'])

def test_v06345_avoids_raw_forbidden_claim_phrases() -> None:
...
def main() -> None:
    test_v06345_primary_files()
    test_v06345_index_files()
    test_v06345_registered_in_run_all()
    test_v06345_avoids_raw_forbidden_claim_phrases()
    print("v0.6.345 safe local-only demo minimal runtime wiring change candidate checks passed")
