...
DOC = ROOT / "docs/255-v06179-public-demo-positioning-review-and-decision.md"
ADR = ROOT / "planning/decisions/ADR-0249-add-v06179-public-demo-positioning-review-and-decision.md"
ISSUE = ROOT / "planning/issues/0248-add-v06179-public-demo-positioning-review-and-decision.md"
V06178_DOC = ROOT / "docs/254-v06178-public-demo-positioning-candidate.md"
...
def main() -> int:
    for path in [POSITIONING, DOC, ADR, ISSUE, V06178_DOC, V06177_DOC, V06176_DOC, SUMMARY, V06173_DOC, V06172_DOC, V06119_DOC]:
    ...
    for phrase in FLAGS:
        require(phrase in doc_text, f"v0.6.179 review/decision document missing flag: {phrase}")

    v06178 = V06178_DOC.read_text(encoding="utf-8")
    for phrase in [
        ...
        require(phrase in v06178, f"v0.6.178 candidate missing required phrase: {phrase}")
    ...
    print("v0.6.179 Public Demo Positioning review and decision tests passed.")
    return 0
