...
DOC = ROOT / "docs/262-v06186-safe-demo-artifact-planning-candidate.md"
ADR = ROOT / "planning/decisions/ADR-0256-add-v06186-safe-demo-artifact-planning-candidate.md"
ISSUE = ROOT / "planning/issues/0255-add-v06186-safe-demo-artifact-planning-candidate.md"
...
def main() -> int:
    for path in [PLAN, DOC, ADR, ISSUE, V06185, V06184, SCENARIO, V06181, V06179, POSITIONING, SUMMARY, V06173, V06172, V06119]:
    ...
    for phrase in FLAGS:
        require(phrase in doc_text, f"v0.6.186 candidate document missing flag: {phrase}")
    ...
    print("v0.6.186 Safe Demo Artifact Planning candidate tests passed.")
    return 0
