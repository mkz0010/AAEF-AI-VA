...
def main() -> int:
    ...
    run([sys.executable, "tools/test_v06165_buyer_facing_commercial_inquiry_boundary_review_and_decision.py"])
    run([sys.executable, "tools/test_v06166_maintainer_inquiry_address_publication_candidate.py"])
    run([sys.executable, "tools/test_v06167_maintainer_inquiry_address_publication_review_and_decision.py"])
    run([sys.executable, "tools/test_v06168_next_work_selection_using_risk_tiered_granularity.py"])
    run([sys.executable, "tools/test_v06169_public_entry_inquiry_route_consistency_review_candidate.py"])
    run([sys.executable, "tools/test_v06170_public_entry_inquiry_route_consistency_review_and_decision.py"])
    run([sys.executable, "tools/test_v06171_next_work_selection_using_risk_tiered_granularity.py"])
    run([sys.executable, "tools/test_v06172_aaef_main_contact_reflection_deferral_decision.py"])
    run([sys.executable, "tools/test_v06173_current_state_and_priority_review.py"])
    ...
    run([sys.executable, "tools/test_v06178_public_demo_positioning_candidate.py"])
    run([sys.executable, "tools/test_v06179_public_demo_positioning_review_and_decision.py"])
    run([sys.executable, "tools/test_v06180_next_work_selection_using_risk_tiered_granularity.py"])
    run([sys.executable, "tools/test_v06181_commercial_inquiry_response_boundary_deferral_decision.py"])
    run([sys.executable, "tools/test_v06182_next_work_selection_using_risk_tiered_granularity.py"])
    run([sys.executable, "tools/test_v06183_safe_demo_scenario_definition_candidate.py"])
    run([sys.executable, "tools/test_v06184_safe_demo_scenario_definition_review_and_decision.py"])
    run([sys.executable, "tools/test_v06185_next_work_selection_using_risk_tiered_granularity.py"])
    run([sys.executable, "tools/test_v06186_safe_demo_artifact_planning_candidate.py"])
    run([sys.executable, "tools/test_v06187_safe_demo_artifact_planning_review_and_decision.py"])
    run([sys.executable, "tools/test_v06188_next_work_selection_using_risk_tiered_granularity.py"])
    run([sys.executable, "tools/test_v06189_safe_demo_fixture_set_planning_candidate.py"])
    ...
    run([sys.executable, "tools/test_v06194_safe_demo_fixture_set_review_and_decision.py"])
    run([sys.executable, "tools/test_v06195_next_work_selection_using_risk_tiered_granularity.py"])
    run([sys.executable, "tools/test_v06196_repository_landing_demo_path_clarity_candidate.py"])
    run([sys.executable, "tools/test_v06197_repository_landing_demo_path_clarity_review_and_decision.py"])
    run([sys.executable, "tools/test_v06198_next_work_selection_using_risk_tiered_granularity.py"])
    run([sys.executable, "tools/test_v06199_public_demo_readiness_review_candidate.py"])
    run([sys.executable, "tools/test_v06200_public_demo_readiness_review_and_decision.py"])
    additional_version_tests = [
        "tools/test_v06201_next_work_selection_using_risk_tiered_granularity.py",
        ...
        "tools/test_v06206_static_fixture_review_path_repository_wording_integration_plan_candidate.py",
        "tools/test_v06207_static_fixture_review_path_repository_wording_integration_plan_review_and_decision.py",
        "tools/test_v06208_next_work_selection_using_risk_tiered_granularity.py",
        ...
        "tools/test_v06215_external_review_public_exposure_commercial_boundary_reassessment.py",
        ...
        "tools/test_v06224_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06225_minimum_flow_scenario_matrix_candidate.py",
        ...
        "tools/test_v06245_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06246_gateway_execution_path_integration_verification_candidate.py",
        ...
        "tools/test_v06251_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06252_read_only_gateway_path_code_inspection_pass_candidate.py",
        "tools/test_v06253_read_only_gateway_path_code_inspection_pass_review_and_decision.py",
        "tools/test_v06254_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06255_read_only_gateway_path_code_inspection_pass_with_findings_candidate.py",
        "tools/test_v06256_read_only_gateway_path_code_inspection_pass_with_findings_review_and_decision.py",
        "tools/test_v06257_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06258_symbol_level_tracing_planning_candidate.py",
        "tools/test_v06259_symbol_level_tracing_planning_review_and_decision.py",
        "tools/test_v06260_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06261_read_only_symbol_level_tracing_pass_candidate.py",
        ...
        "tools/test_v06266_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06267_narrower_manual_trace_review_candidate.py",
        ...
        "tools/test_v06272_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06273_manual_trace_review_follow_up_trace_candidate.py",
        "tools/test_v06274_manual_trace_review_follow_up_trace_candidate_review_and_decision.py",
        "tools/test_v06275_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06276_manual_trace_review_follow_up_trace.py",
        "tools/test_v06277_manual_trace_review_follow_up_trace_review_and_decision.py",
        "tools/test_v06278_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06279_continued_follow_up_trace_planning_candidate.py",
        "tools/test_v06280_continued_follow_up_trace_planning_candidate_review_and_decision.py",
        "tools/test_v06281_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06282_continued_follow_up_trace_candidate.py",
        "tools/test_v06283_continued_follow_up_trace_candidate_review_and_decision.py",
        "tools/test_v06284_next_work_selection_using_risk_tiered_granularity.py",
        ...
        "tools/test_v06289_safe_mock_demo_initial_path_hardening_candidate.py",
        "tools/test_v06290_safe_mock_demo_initial_path_hardening_candidate_review_and_decision.py",
        "tools/test_v06291_safe_mock_demo_initial_path_hardening.py",
        ...
        "tools/test_v06296_safe_mock_demo_pre_public_boundary_review.py",
        "tools/test_v06297_safe_mock_demo_pre_public_boundary_review_and_decision.py",
        "tools/test_v06298_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06299_safe_mock_demo_public_artifact_promotion_candidate.py",
        "tools/test_v06300_safe_mock_demo_public_artifact_promotion_candidate_review_and_decision.py",
        ...
        "tools/test_v06308_safe_local_only_runnable_demo_path_candidate.py",
        "tools/test_v06309_safe_local_only_runnable_demo_path_candidate_review_and_decision.py",
        "tools/test_v06310_safe_local_only_runnable_demo_path.py",
        "tools/test_v06311_safe_local_only_runnable_demo_path_review_and_decision.py",
        "tools/test_v06312_safe_local_only_runnable_demo_path_creation_readiness_review.py",
        "tools/test_v06313_safe_local_only_runnable_demo_path_creation_candidate.py",
        "tools/test_v06314_safe_local_only_runnable_demo_path_creation_candidate_review_and_decision.py",
        "tools/test_v06315_safe_local_only_runnable_demo_path_creation.py",
        ...
        "tools/test_v06320_safe_local_only_runnable_demo_public_positioning_review.py",
        "tools/test_v06321_safe_local_only_runnable_demo_public_positioning_candidate.py",
        "tools/test_v06322_safe_local_only_runnable_demo_public_positioning_candidate_review_and_decision.py",
        "tools/test_v06323_safe_local_only_runnable_demo_public_positioning_integration_plan_candidate.py",
        "tools/test_v06324_safe_local_only_runnable_demo_public_positioning_integration_plan_candidate_review_and_decision.py",
        "tools/test_v06325_safe_local_only_runnable_demo_public_positioning_integration_implementation_candidate.py",
        "tools/test_v06326_safe_local_only_runnable_demo_public_positioning_integration_implementation_candidate_review_and_decision.py",
        "tools/test_v06327_safe_local_only_runnable_demo_public_positioning_integration_closeout_review.py",
        "tools/test_v06328_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06329_safe_local_only_demo_runtime_application_readiness_review.py",
        "tools/test_v06330_safe_local_only_demo_runtime_application_candidate.py",
        "tools/test_v06331_safe_local_only_demo_runtime_application_candidate_review_and_decision.py",
        "tools/test_v06332_safe_local_only_demo_runtime_application_closeout_review.py",
        "tools/test_v06333_next_work_selection_using_risk_tiered_granularity.py",
        "tools/test_v06334_safe_local_only_demo_runtime_application_go_no_go_review.py",
        ...
        "tools/test_v06339_safe_local_only_demo_minimal_runtime_wiring_readiness_review.py",
        "tools/test_v06340_safe_local_only_demo_minimal_runtime_wiring_candidate.py",
        "tools/test_v06341_safe_local_only_demo_minimal_runtime_wiring_candidate_review_and_decision.py",
        "tools/test_v06342_safe_local_only_demo_minimal_runtime_wiring_closeout_review.py",
...
"tools/test_v06379_controlled_executor_validation_explicit_command_plan_exposure_candidate.py",
"tools/test_v06380_controlled_executor_validation_explicit_command_plan_exposure_candidate_review_and_decision.py",
