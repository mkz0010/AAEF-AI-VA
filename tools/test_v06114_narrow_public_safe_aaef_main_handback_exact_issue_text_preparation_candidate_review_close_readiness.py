...
DOC = ROOT / "docs/190-v06114-narrow-public-safe-aaef-main-handback-exact-issue-text-preparation-candidate-review-close-readiness.md"
V06113_DOC = ROOT / "docs/189-v06113-narrow-public-safe-aaef-main-handback-exact-issue-text-preparation-candidate.md"
V06112_DOC = ROOT / "docs/188-v06112-narrow-public-safe-aaef-main-handback-exact-issue-text-preparation-planning.md"
...
def main() -> int:
    for path in [DOC, V06113_DOC, V06112_DOC, V0655_DOC, INDEX, VALIDATOR]:
    ...
    for phrase in REQUIRED_PHRASES + REQUIRED_FLAGS:
        require(phrase in doc_text, f"v0.6.114 document missing required text: {phrase}")

    for category in EXPECTED_CATEGORIES:
        require(category in doc_text, f"v0.6.114 document missing retained category: {category}")
        ...
        require("expected_failure_category" not in metadata, f"v0.6.114 must not add metadata-level failure category: {category}")
    ...
    for phrase in [
        "narrow_public_safe_aaef_main_handback_exact_issue_text_preparation_candidate_added = true",
        "exact_issue_text_candidate_generated = true",
        ...
        "selected_next_step_after_exact_issue_text_preparation_candidate = narrow_public_safe_aaef_main_handback_exact_issue_text_preparation_candidate_review_close_readiness",
        "narrow_public_safe_aaef_main_handback_exact_issue_text_preparation_candidate_review_authorized_for_next_checkpoint = true",
        "narrow_public_safe_aaef_main_handback_exact_issue_text_submission_decision_authorized_for_next_checkpoint = false",
        ...
        require(phrase in v06113, f"v0.6.113 baseline missing required phrase: {phrase}")

    v06112 = V06112_DOC.read_text(encoding="utf-8")
    require(
        "selected_next_step_after_exact_issue_text_preparation_planning = narrow_public_safe_aaef_main_handback_exact_issue_text_preparation_candidate" in v06112,
        "v0.6.112 must select exact issue text candidate",
    )
    ...
    for phrase in [
        ...
        require(phrase not in lower_doc, f"v0.6.114 document must not include affirmative overclaim phrase: {phrase}")

    print("v0.6.114 narrow public-safe AAEF main handback exact issue text preparation candidate review close-readiness tests passed.")
    return 0
