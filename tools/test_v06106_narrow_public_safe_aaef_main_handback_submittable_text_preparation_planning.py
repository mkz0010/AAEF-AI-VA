...
DOC = ROOT / "docs/182-v06106-narrow-public-safe-aaef-main-handback-submittable-text-preparation-planning.md"
V06105_DOC = ROOT / "docs/181-v06105-applied-evidence-handback-submittable-text-or-pause-decision.md"
V06104_DOC = ROOT / "docs/180-v06104-narrow-public-safe-aaef-main-handback-final-text-preparation-candidate-review-close-readiness.md"
...
def main() -> int:
    for path in [DOC, V06105_DOC, V06104_DOC, V0655_DOC, INDEX, VALIDATOR]:
    ...
    for phrase in REQUIRED_PHRASES + REQUIRED_FLAGS:
        require(phrase in doc_text, f"v0.6.106 document missing required text: {phrase}")

    for category in EXPECTED_CATEGORIES:
        require(category in doc_text, f"v0.6.106 document missing retained category: {category}")
        ...
        require("expected_failure_category" not in metadata, f"v0.6.106 must not add metadata-level failure category: {category}")
    ...
    for phrase in [
        "applied_evidence_handback_submittable_text_or_pause_decision_completed = true",
        "selected_next_step_after_final_text_candidate_closeout = narrow_public_safe_aaef_main_handback_submittable_text_preparation_planning",
        "narrow_public_safe_aaef_main_handback_submittable_text_preparation_planning_selected = true",
        "narrow_public_safe_aaef_main_handback_submittable_text_preparation_planning_started = false",
        "narrow_public_safe_aaef_main_handback_submittable_text_preparation_planning_implemented = false",
        "aaef_main_handback_submittable_text_preparation_planning_authorized_for_next_checkpoint = true",
        "aaef_main_handback_submittable_text_candidate_authorized_for_next_checkpoint = false",
        ...
        require(phrase in v06105, f"v0.6.105 baseline missing required phrase: {phrase}")

    v06104 = V06104_DOC.read_text(encoding="utf-8")
    require("narrow_public_safe_aaef_main_handback_final_text_preparation_candidate_close_ready = true" in v06104, "v0.6.104 final-text candidate close-readiness must exist")
    ...
    for phrase in [
        ...
        "this planning creates submittable text",
        "scanner execution is authorized by this planning",
        "runtime execution is authorized by this planning",
    ]:
        require(phrase not in lower_doc, f"v0.6.106 document must not include affirmative overclaim phrase: {phrase}")

    print("v0.6.106 narrow public-safe AAEF main handback submittable text preparation planning tests passed.")
    return 0
