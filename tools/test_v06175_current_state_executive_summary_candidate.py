...
DOC = ROOT / "docs/251-v06175-current-state-executive-summary-candidate.md"
ADR = ROOT / "planning/decisions/ADR-0245-add-v06175-current-state-executive-summary-candidate.md"
ISSUE = ROOT / "planning/issues/0244-add-v06175-current-state-executive-summary-candidate.md"
...
def main() -> int:
    for path in [SUMMARY, DOC, ADR, ISSUE, V06174_DOC, V06173_DOC, V06172_DOC, V06170_DOC, V06167_DOC, V06119_DOC]:
    ...
    for phrase in FLAGS:
        require(phrase in doc_text, f"v0.6.175 candidate document missing flag: {phrase}")
    ...
    print("v0.6.175 Current-State Executive Summary candidate tests passed.")
    return 0
