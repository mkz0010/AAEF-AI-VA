...
DOC = ROOT / "docs/219-v06143-enterprise-review-guide-candidate.md"
ADR = ROOT / "planning/decisions/ADR-0213-add-v06143-enterprise-review-guide-candidate.md"
ISSUE = ROOT / "planning/issues/0212-add-v06143-enterprise-review-guide-candidate.md"
...
REQUIRED_DOC_PHRASES = ['Status: candidate', 'This is checkpoint 1 of 2 for a Medium-risk buyer/reviewer-facing documentation work item.', 'This checkpoint creates the Enterprise Review Guide candidate.', 'The review and decision are deferred to v0.6.144.', 'Candidate implementation summary', 'Candidate guide', 'Claim boundaries', 'Candidate tests', 'What changed', 'What did not happen', 'Next checkpoint', 'v0.6.144 Enterprise Review Guide Review and Decision']
...
FLAGS = ['enterprise_review_guide_candidate_completed = true', 'enterprise_review_guide_candidate_is_medium_risk = true', 'enterprise_review_guide_candidate_checkpoint_1_of_2 = true', 'enterprise_review_guide_review_decision_deferred_to_v06144 = true', 'enterprise_review_guide_created = true', 'enterprise_review_guide_candidate_claim_safe = true', 'enterprise_review_guide_target_reader_identified = true', 'enterprise_review_guide_project_positioning_included = true', 'enterprise_review_guide_review_questions_included = true', 'enterprise_review_guide_evidence_review_path_included = true', 'enterprise_review_guide_gate_semantics_review_included = true', 'enterprise_review_guide_demo_boundary_included = true', 'enterprise_review_guide_non_goals_included = true', 'enterprise_review_guide_deployment_due_diligence_prompts_included = true', 'enterprise_review_guide_commercial_evaluation_boundary_included = true', 'enterprise_review_guide_review_decision_completed = false', 'review_decision_completed = false', 'validator_behavior_modified = false', 'metadata_level_expected_failure_category_added = false', 'json_schema_added = false', 'public_sample_changed = false', 'runtime_behavior_modified = false', 'runtime_execution_authorized = false', 'scanner_execution_authorized = false', 'docker_execution_authorized = false', 'credential_injection_permitted = false', 'customer_target_authorized = false', 'delivery_authorized = false', 'aaef_main_handback_sequence_remains_paused = true', 'aaef_main_handback_sequence_reopened = false', 'aaef_main_issue_opened = false', 'aaef_main_pull_request_opened = false', 'aaef_main_issue_submission_command_generated = false', 'aaef_main_issue_url_generated = false', 'technical_due_diligence_summary_created = false', 'safe_poc_boundary_template_created = false', 'control_matrix_created = false', 'reviewer_walkthrough_created = false', 'mock_completed_status_renamed = false', 'mock_dry_run_status_behavior_modified = false', 'external_discovery_fail_closed_added = false', 'constraint_diff_enforcement_added = false', 'authorization_expiry_now_check_added = false', 'certification_claim_occurs = false', 'legal_compliance_claim_occurs = false', 'audit_opinion_claim_occurs = false', 'production_readiness_claim_occurs = false', 'external_framework_equivalence_claim_occurs = false', 'diagnostic_completeness_claim_occurs = false', 'third_party_testing_authorization_claim_occurs = false', 'aaef_core_promotion = false', 'aaef_profile_promotion = false', 'aaef_practical_package_promotion = false', 'selected_next_checkpoint = v0.6.144 Enterprise Review Guide Review and Decision']
...
FORBIDDEN_AFFIRMATIVE_PHRASES = [
    ...
    "authorized for third-party testing",
    ...
    "aaef core promotion",
    "aaef profile promotion",
    "aaef practical package promotion",
]
...
def main() -> int:
    for path in [GUIDE, DOC, ADR, ISSUE, V06142_DOC, V06141_DOC, V06138_DOC, V06134_DOC, V06130_DOC, V06119_DOC]:
    ...
    for phrase in REQUIRED_DOC_PHRASES + FLAGS:
        require(phrase in doc_text, f"v0.6.143 document missing required text: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase in guide_text, f"Enterprise Review Guide missing reviewer question/framing: {phrase}")
    ...
    for phrase in [
        ...
        require(phrase not in lower_doc, f"v0.6.143 document must not include affirmative forbidden phrase: {phrase}")

    print("v0.6.143 Enterprise Review Guide candidate tests passed.")
    return 0
