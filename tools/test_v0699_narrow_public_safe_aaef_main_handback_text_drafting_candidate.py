...
DOC = ROOT / "docs/175-v0699-narrow-public-safe-aaef-main-handback-text-drafting-candidate.md"
V0698_DOC = ROOT / "docs/174-v0698-narrow-public-safe-aaef-main-handback-text-drafting-planning.md"
V0697_DOC = ROOT / "docs/173-v0697-applied-evidence-handback-material-drafting-or-submission-decision.md"
...
REQUIRED_FLAGS = [
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_added = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_is_documentation_only = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_uses_v0698_planning = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_uses_v0697_decision = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_generated = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_close_readiness_may_be_considered = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_scope_preserved = true",
    ...
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_reviewer_aid_generated = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_candidate_internal_only = true",
    "narrow_public_safe_aaef_main_handback_text_drafting_planning_retained = true",
    "narrow_public_safe_aaef_main_handback_text_candidate_generated = true",
    ...
    "aaef_main_handback_text_drafting_candidate_authorized_for_next_checkpoint = false",
...
def main() -> int:
    for path in [DOC, V0698_DOC, V0697_DOC, V0655_DOC, INDEX, VALIDATOR]:
    ...
    required_phrases = [
        "Status: candidate",
        "It is a text drafting candidate checkpoint only.",
        ...
        "Internal text drafting candidate packet",
        "Candidate text draft",
        "The following text is an internal candidate only.",
        "AAEF-AI-VA may provide a narrow Applied Implementation lesson",
        "The public-safe lesson is that evidence can preserve the distinction between an AI-generated request and the authority to execute an action.",
        "AI output is a request, not authority.",
        "A gate or authorization decision remains the authority-relevant boundary",
        "Dispatch and non-dispatch both benefit from evidence.",
        "Validator output can support structural review of public examples, but validator output is not execution authority.",
        "Static public samples are orientation artifacts",
        "AAEF-AI-VA should remain an Applied Implementation boundary example.",
        "Candidate text review notes",
        "Remains internal and non-submittable",
        "Retained permitted wording families",
        "Retained forbidden wording families",
        "This text is ready for direct AAEF main submission.",
        "This text is final handback text.",
        "Retained allowed sources",
        "Retained forbidden sources",
    ...
    for phrase in required_phrases + REQUIRED_FLAGS:
        require(phrase in doc_text, f"v0.6.99 document missing required text: {phrase}")

    for category in EXPECTED_CATEGORIES:
        require(category in doc_text, f"v0.6.99 document missing retained category: {category}")
        ...
        require("expected_failure_category" not in metadata, f"v0.6.99 must not add metadata-level failure category: {category}")
    ...
    v0698 = V0698_DOC.read_text(encoding="utf-8")
    for phrase in [
        ...
        require(phrase in v0698, f"v0.6.98 baseline missing required phrase: {phrase}")

    v0697 = V0697_DOC.read_text(encoding="utf-8")
    require(
        "selected_next_step_after_material_preparation_closeout = narrow_public_safe_aaef_main_handback_text_drafting_planning" in v0697,
        "v0.6.97 must select text drafting planning",
    )
    ...
    for phrase in [
        ...
        "this candidate writes final aaef main handback text",
        ...
        require(phrase not in lower_doc, f"v0.6.99 document must not include affirmative overclaim phrase: {phrase}")

    print("v0.6.99 narrow public-safe AAEF main handback text drafting candidate tests passed.")
    return 0
