...
DOC = ROOT / "docs/333-v06258-symbol-level-tracing-planning-candidate.md"
ADR = ROOT / "planning/decisions/ADR-0333-add-v06258-symbol-level-tracing-planning-candidate.md"
ISSUE = ROOT / "planning/issues/0333-add-v06258-symbol-level-tracing-planning-candidate.md"
...
REQUIRED_DOC_TOKENS = [
    ...
    "Symbol-Level Tracing Planning Candidate",
...
def test_v06258_issue_tokens() -> None:
    assert_tokens(
        ISSUE,
        [
            "0333 - Add v0.6.258 Symbol-Level Tracing Planning Candidate",
            "Status: completed by v0.6.258",
            ...
            "symbol_level_tracing_results_created = false",
            "accepted_defect_records_created = false",
            "Proceed to v0.6.259 Symbol-Level Tracing Planning Review and Decision",
        ],
    )


def test_v06258_index_tokens() -> None:
    assert_tokens(
        README,
        [
            "v0.6.258 Symbol-Level Tracing Planning Candidate",
...
def test_v06258_registered_in_run_all() -> None:
    assert_tokens(RUN_ALL, ["tools/test_v06258_symbol_level_tracing_planning_candidate.py"])


def main() -> None:
    test_v06258_doc_tokens()
    test_v06258_adr_tokens()
    test_v06258_issue_tokens()
    test_v06258_index_tokens()
    test_v06258_registered_in_run_all()
    print("v0.6.258 symbol-level tracing planning candidate checks passed")
