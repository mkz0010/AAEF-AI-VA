# Issue 0251: Add v0.6.182 next work selection using risk-tiered granularity

## Summary

Apply the v0.6.120 checkpoint granularity policy by selecting the next work item after v0.6.181, assigning its risk tier, and assigning its checkpoint count.

## Acceptance criteria

* Add `docs/258-v06182-next-work-selection-using-risk-tiered-granularity.md`.
* Add `planning/decisions/ADR-0252-add-v06182-next-work-selection-using-risk-tiered-granularity.md`.
* Add this issue note.
* Add `tools/test_v06182_next_work_selection_using_risk_tiered_granularity.py`.
* Register the v0.6.182 test in `tools/run_all_local_checks.py`.
* Confirm v0.6.181 deferred Commercial Inquiry Response Boundary before candidate creation.
