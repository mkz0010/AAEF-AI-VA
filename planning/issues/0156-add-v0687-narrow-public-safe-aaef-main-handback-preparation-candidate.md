# Issue 0156: Add v0.6.87 narrow public-safe AAEF main handback preparation candidate

## Summary

Add a v0.6.87 internal preparation candidate after v0.6.86 planned narrow public-safe AAEF main handback preparation controls.

## Acceptance criteria

* Add `docs/163-v0687-narrow-public-safe-aaef-main-handback-preparation-candidate.md`.
* Add `planning/decisions/ADR-0157-add-v0687-narrow-public-safe-aaef-main-handback-preparation-candidate.md`.
* Add this issue note.
* Add `tools/test_v0687_narrow_public_safe_aaef_main_handback_preparation_candidate.py`.
* Register the v0.6.87 test in `tools/run_all_local_checks.py`.
* Confirm v0.6.86 preparation planning exists.
* Confirm the preparation candidate is internal and documentation-only.
