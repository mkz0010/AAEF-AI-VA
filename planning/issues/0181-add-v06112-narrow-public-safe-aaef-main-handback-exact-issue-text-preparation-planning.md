# Issue 0181: Add v0.6.112 narrow public-safe AAEF main handback exact issue text preparation planning

## Summary

Add a v0.6.112 planning checkpoint after v0.6.111 selected the AAEF main issue workflow and exact issue text preparation planning.

## Acceptance criteria

* Add `docs/188-v06112-narrow-public-safe-aaef-main-handback-exact-issue-text-preparation-planning.md`.
* Add `planning/decisions/ADR-0182-add-v06112-narrow-public-safe-aaef-main-handback-exact-issue-text-preparation-planning.md`.
* Add this issue note.
* Add `tools/test_v06112_narrow_public_safe_aaef_main_handback_exact_issue_text_preparation_planning.py`.
* Register the v0.6.112 test in `tools/run_all_local_checks.py`.
* Confirm v0.6.111 workflow selection decision exists.
* Plan exact issue text preparation without generating exact issue text.
