# Issue 0157: Add v0.6.88 narrow public-safe AAEF main handback preparation review and close-readiness

## Summary

Add a v0.6.88 checkpoint that reviews and closes the v0.6.87 internal narrow public-safe AAEF main handback preparation candidate.

## Acceptance criteria

* Add `docs/164-v0688-narrow-public-safe-aaef-main-handback-preparation-review-close-readiness.md`.
* Add `planning/decisions/ADR-0158-add-v0688-narrow-public-safe-aaef-main-handback-preparation-review-close-readiness.md`.
* Add this issue note.
* Add `tools/test_v0688_narrow_public_safe_aaef_main_handback_preparation_review_close_readiness.py`.
* Register the v0.6.88 test in `tools/run_all_local_checks.py`.
* Confirm v0.6.87 preparation candidate exists.
* Confirm the preparation candidate is retained and close-ready.
