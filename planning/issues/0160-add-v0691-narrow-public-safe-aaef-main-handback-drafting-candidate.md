# Issue 0160: Add v0.6.91 narrow public-safe AAEF main handback drafting candidate

## Summary

Add a v0.6.91 internal drafting candidate after v0.6.90 planned narrow public-safe AAEF main handback drafting controls.

## Acceptance criteria

* Add `docs/167-v0691-narrow-public-safe-aaef-main-handback-drafting-candidate.md`.
* Add `planning/decisions/ADR-0161-add-v0691-narrow-public-safe-aaef-main-handback-drafting-candidate.md`.
* Add this issue note.
* Add `tools/test_v0691_narrow_public_safe_aaef_main_handback_drafting_candidate.py`.
* Register the v0.6.91 test in `tools/run_all_local_checks.py`.
* Confirm v0.6.90 drafting planning exists.
* Confirm the drafting candidate is internal and documentation-only.
* Confirm no AAEF main handback material is prepared.
* Confirm no AAEF main issue, PR, release note, document change, or final handback text is created.
* Confirm no handback package or handback draft is created.
