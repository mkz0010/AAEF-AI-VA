# Issue 0159: Add v0.6.90 narrow public-safe AAEF main handback drafting planning

## Summary

Add a v0.6.90 planning checkpoint after v0.6.89 selected narrow public-safe AAEF main handback drafting planning.

## Acceptance criteria

* Add `docs/166-v0690-narrow-public-safe-aaef-main-handback-drafting-planning.md`.
* Add `planning/decisions/ADR-0160-add-v0690-narrow-public-safe-aaef-main-handback-drafting-planning.md`.
* Add this issue note.
* Add `tools/test_v0690_narrow_public_safe_aaef_main_handback_drafting_planning.py`.
* Register the v0.6.90 test in `tools/run_all_local_checks.py`.
* Confirm v0.6.89 handback drafting decision exists.
* Confirm drafting planning is documentation-only.
...
* Confirm no handback package, handback draft, or handback drafting candidate is created.
...
* Do not create a handback package, handback draft, or handback drafting candidate.
