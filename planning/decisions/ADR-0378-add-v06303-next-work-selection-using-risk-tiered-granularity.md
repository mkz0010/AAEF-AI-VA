# ADR-0378: Select Safe Local-Only Demo Execution Boundary Candidate
...
v0.6.302 accepted the safe mock demo public artifact as a documentation-only public artifact.
...
The project should next create a Safe Local-Only Demo Execution Boundary Candidate. Publication approval, public announcement, runtime readiness, scanner readiness, execution authorization, and real execution remain deferred.
