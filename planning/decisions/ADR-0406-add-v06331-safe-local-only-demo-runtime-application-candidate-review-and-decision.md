# ADR-0406: Accept Safe Local-Only Demo Runtime Application Candidate
...
v0.6.330 created a bounded safe local-only demo runtime application candidate without changing runtime behavior.
...
The project should next close out this runtime application candidate track. Execution authorization, real execution, external targets, public/customer demo readiness, runtime behavior changes, and scanner readiness remain deferred.
