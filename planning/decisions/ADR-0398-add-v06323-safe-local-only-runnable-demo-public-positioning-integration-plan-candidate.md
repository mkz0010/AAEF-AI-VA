# ADR-0398: Create Safe Local-Only Runnable Demo Public Positioning Integration Plan Candidate
...
v0.6.322 accepted the public positioning candidate for the safe local-only runnable demo.
...
The project should next review and decide whether to accept this integration plan candidate. Publication, customer demonstration, runtime application, runtime readiness, scanner readiness, execution authorization, and real execution remain deferred.
