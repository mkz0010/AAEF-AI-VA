# ADR-0385: Define Safe Local-Only Runnable Demo Path
...
v0.6.309 accepted the Safe Local-Only Runnable Demo Path Candidate.
...
The project should next review and decide whether to accept this path definition. Runnable path creation, runtime application, runtime readiness, scanner readiness, execution authorization, and real execution remain deferred.
