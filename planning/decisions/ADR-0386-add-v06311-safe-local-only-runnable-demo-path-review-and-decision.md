# ADR-0386: Accept Safe Local-Only Runnable Demo Path
...
v0.6.310 defined the Safe Local-Only Runnable Demo Path as a documentation-level path.
...
The project should next review readiness for creating the safe local-only runnable demo path. Runnable path creation, runtime application, runtime readiness, scanner readiness, execution authorization, and real execution remain deferred.
