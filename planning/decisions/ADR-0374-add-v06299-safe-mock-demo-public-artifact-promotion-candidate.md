# ADR-0374: Create Safe Mock Demo Public Artifact Promotion Candidate
...
v0.6.298 selected `safe_mock_demo_public_artifact_promotion_candidate` as the next work item.
...
The project should next review this candidate before actual public artifact promotion or publication approval.
