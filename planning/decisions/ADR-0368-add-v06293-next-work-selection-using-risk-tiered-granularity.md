# ADR-0368: Select Safe Mock Demo Pre-Public Boundary Review Candidate
...
v0.6.292 accepted documentation-only safe mock demo initial path hardening.
...
The project should next create a pre-public boundary review candidate for the safe mock demo path before any public artifact promotion or publication approval.
