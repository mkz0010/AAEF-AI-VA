# ADR-0360: Perform Continued Follow-Up Trace
...
v0.6.284 selected `continued_follow_up_trace` as the next work item after v0.6.283 accepted the Continued Follow-Up Trace Candidate.

## Decision

Perform the bounded Continued Follow-Up Trace and create non-claim continued trace records/results/dispositions/gap triage.
