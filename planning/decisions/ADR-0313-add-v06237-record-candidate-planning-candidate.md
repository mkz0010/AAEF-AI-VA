# ADR-0313: Create Record Candidate Planning Candidate
...
v0.6.236 selected `record_candidate_planning` as the next work item after v0.6.235 accepted the Future Record Planning Candidate for future fixture planning and record candidate planning.

The next step is to create a documentation-only candidate plan for future record candidate artifacts before creating those artifacts, actual records, or fixtures.
...
A later checkpoint can review whether this Record Candidate Planning Candidate should be accepted for future record candidate artifact creation planning.
...
Runtime demo remains necessary but deferred. Publication remains deferred. No private generated outputs are moved public in v0.6.237.
