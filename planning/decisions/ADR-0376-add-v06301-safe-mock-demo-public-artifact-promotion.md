# ADR-0376: Promote Safe Mock Demo Public Artifact
...
v0.6.300 accepted the Safe Mock Demo Public Artifact Promotion Candidate for future public artifact promotion.

## Decision

Create the documentation-only safe mock demo public artifact at `docs/public-artifacts/safe-mock-demo-public-artifact.md`.
...
The project should next review and decide whether to accept the promoted public artifact. Publication approval, public announcement, local-only execution boundary work, runtime readiness, scanner readiness, and real execution remain deferred.
